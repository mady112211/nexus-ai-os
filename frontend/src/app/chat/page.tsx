  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      role: 'nexus',
      content: "Hello! I'm NEXUS AI OS. Tell me what you want to build or accomplish, and I'll create a mission and execute it for you.\n\nExamples:\n• Create a marketing plan for my business\n• Build a social media strategy\n• Analyze my competitor landscape",
      timestamp: new Date(),
    },
  ]);
              ...
              >
                {message.role === 'nexus' && (
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs text-blue-400 font-medium">NEXUS AI OS</span>
                  </div>
                )}
                ...
                {message.mission && (
                  <div className="mt-3 bg-gray-800 border border-gray-700 rounded-xl p-4">
                    ...
                    <button
                      onClick={() => router.push(`/missions/${message.mission!.id}`)}
